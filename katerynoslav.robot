...
Library  Collections
Library  katerynoslav_service.py
...
Підготувати клієнт для користувача
  ...
  Run Keyword If  '${username}' != 'katerynoslav_Viewer'  Login  ${username}
...
Завантажити документ
  ...
  katerynoslav.Пошук тендера по ідентифікатору  ${username}  ${TENDER}
...
Скасувати закупівлю
  ...
  katerynoslav.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid} 
...
Отримати інформацію із предмету
  ...
  ${return_value}=  Run Keyword If  '${field_name}' == 'contractPeriod.startDate'  katerynoslav_service.convert_DMY_ISO  ${return_value}
  ...  ELSE IF  '${field_name}' == 'contractPeriod.endDate'  katerynoslav_service.convert_DMY_ISO  ${return_value}
...
Отримати інформацію про items[${index}].contractPeriod.startDate
  ...
  ${return_value}=  katerynoslav_service.convert_DMY_ISO  ${date_value}
  [return]  ${return_value}
...
Отримати інформацію про items[0].deliveryDate.endDate
  ...
  ${return_value}=  katerynoslav_service.convert_date  ${date_value}
  [return]  ${return_value}
...
Додати предмет закупівлі
  ...
  katerynoslav.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
  ${index}=  katerynoslav.Отримати кількість предметів в тендері  ${username}  ${tender_uaid}
...
Дискваліфікувати постачальника
  ...
  katerynoslav.Оновити сторінку з тендером  ${username}  ${tender_uaid}
  ${award_index}=  inc  ${award_index}
